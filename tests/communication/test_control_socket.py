...
class TestControlSocket:
    ...
    async def test_socket_creation(self):
        ...
        socket_path = Path('/tmp/statemachine-control-test_machine.sock')
    ...
    async def test_new_job_event_triggers_wake_up(self):
        ...
        socket_path = '/tmp/statemachine-control-test_wake_machine.sock'
    ...
    async def test_inter_machine_event_handling(self):
        ...
        socket_path = '/tmp/statemachine-control-test_receiver.sock'
        client_sock.sendto(json.dumps(event).encode('utf-8'), socket_path)
        client_sock.close()
    ...
    async def test_invalid_json_handling(self):
        ...
        # Send invalid JSON
        client_sock = socket.socket(socket.AF_UNIX, socket.SOCK_DGRAM)
        socket_path = '/tmp/statemachine-control-test_invalid.sock'
    ...
    async def test_multiple_events_in_sequence(self):
        ...
        socket_path = '/tmp/statemachine-control-test_multiple.sock'
...
class TestIntegration:
    ...
    async def test_latency_measurement(self):
        ...
        socket_path = '/tmp/statemachine-control-test_latency.sock'
